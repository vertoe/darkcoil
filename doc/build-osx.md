...
4.  (Optional) You can also install darkcoind to your path:
...
4. Enter "darkcoin-qt" as project name, enter src/qt as location
...
darkcoind/darkcoin-cli binaries are not included in the Darkcoin-Qt.app bundle.

If you are building `darkcoind` or `Darkcoin-Qt` for others, your build machine should be set up
