...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -conf=<file>           " + strprintf(_("Specify configuration file (default: %s)"), "darkcoin.conf") + "\n";
...
#ifndef WIN32
    strUsage += "  -pid=<file>            " + strprintf(_("Specify pid file (default: %s)"), "darkcoind.pid") + "\n";
#endif
...
{
    return FormatParagraph(_("Copyright (C) 2009-2014 The Bitcoin Core Developers") + "\n" + strprintf(_("Copyright (C) 2014-%i The Darkcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
