...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Darkcoil.lnk";
}
...
{
    return GetAutostartDir() / "darkcoil.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Darkcoil-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  darkcoil-qt [" + tr("command-line options") + "]                     " + "\n";
