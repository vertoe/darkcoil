    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText2   = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Darkcoin developers"));
    QString copyrightText3   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The DARKCOIL project"));
