...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "Darkcoil",
    ...
    QApplication::setOrganizationDomain("darkco.in");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Darkcoil-Qt-testnet");
    else
        QApplication::setApplicationName("Darkcoil-Qt");
